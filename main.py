...
def session_test():
    if 'visits_count' in flask.session:
        flask.session['visits_count'] = flask.session.get('visits_count') + 1
    else:
        flask.session['visits_count'] = 1
    return f'{flask.session["visits_count"]}'
